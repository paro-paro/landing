...
const originadores = [
  {
    ...
    farmers: [
      ...
      { name: "Reserva 1920", slug: "reserva-1920" },
      {
        ...
        slug: "productos-agroalimentarios",
      },
      { name: "Sierra Azul", slug: "sierra-azul" },
    ],
  },
  {
    country: "Colombia",
  ...
  },
  {
    country: "Brasil",
    flag: "🇧🇷",
    farmers: [{ name: "Um Coffee", slug: "um-coffee" }],
  },
  {
    country: "Ecuador",
    flag: "🇪🇨",
    farmers: [{ name: "Nortfruit", slug: "nortfruit" }],
  },
  {
    country: "Perú",
    flag: "🇵🇪",
    farmers: [{ name: "Agros", slug: "agros" }],
  },
];

const avatars = ["/boram.avif", "/neriortiz.jpg", "/nicole.png"];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-5rem)] py-12 pt-24 sm:py-20 sm:pt-32">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left order-1 lg:order-2">
              ...
              <p className="mt-4 text-2xl sm:text-3xl font-semibold text-primary">
                {t("subtitle")}
              </p>
              ...
              <div className="mt-10 flex flex-col-reverse sm:flex-row items-center lg:items-start gap-4">
                ...
                >
                  <Link
                    href="https://www.instagram.com/ethichub_greencoffee/"
                    target="_blank"
                ...
                <Button size="lg" className="gap-2 px-8" asChild>
                  <Link
                    href="https://app.ethichub.com/lending"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {t("startLending")}
            ...
            {originadores.map((origin) => (
              ...
              >
                ...
                <span className="text-xs text-muted-foreground">
                  {origin.farmers.length}{" "}
                  {origin.farmers.length > 1
                    ? t("originators.originators")
                    : t("originators.originator")}
                </span>
              </div>
            ))}
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {originadores.flatMap((origin) =>
              origin.farmers.map((farmer) => {
                const imagePath =
                  originatorImages[farmer.slug] || "/placeholder.jpg";
                return (
                  <HoverPrefetchLink
                    key={farmer.slug}
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <CardContent className="p-6 md:p-8 flex flex-col h-full">
                  ...
                  <p className="text-sm md:text-base text-foreground leading-relaxed mb-6 grow">
                    {testimonial.quote}"
                  </p>
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm text-muted-foreground italic mt-1">
